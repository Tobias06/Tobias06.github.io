...
db.collection("plantacion").onSnapshot((querySnapshot) => {
    ...
    <td>
      <div class="table-data-feature">
        ...
        <button class="mdc-button mdc-button--raised icon-button filled-button--light" type="item" data-toggle="modal" data-target="#clearbutton2" type="button" title="Editar" onclick="editarPlantacion('${doc.id}','${doc.data().anio_p}','${doc.data().albedo_p}','${doc.data().insolacion_p}','${doc.data().capaAtm_p}','${doc.data().denAire_p}','${doc.data().velocidadVient_p}','${doc.data().cultDuracion_p}','${doc.data().evap_p}','${doc.data().coeficiente_p}','${doc.data().enegiaLib_p}','${doc.data().lluvia_p}','${doc.data().lluviaCircular_p}','${doc.data().elva_p}',
        '${doc.data().densidadKgm_p}','${doc.data().transpir_p}','${doc.data().perdSuelo_p}','${doc.data().ContMat_p}','${doc.data().nitro_p}','${doc.data().fosf_p}','${doc.data().pota_p}','${doc.data().urea_p}','${doc.data().cal_p}','${doc.data().fert_p}','${doc.data().semi_p}','${doc.data().maEqu_p}','${doc.data().pesFung_p}')">
